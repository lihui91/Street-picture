# -*- coding: utf-8 -*-
"""
Created on Sat Feb 13 20:16:09 2021
...
#这里的路径可替换为自己保存文件夹的路径
save_path = r"C:\Users\19215\Desktop\pic1/"

ak = "EkFfRokGm9WWzUBBQbdeFGSK4RwM5a7z"
...
#替换为你自己制作的txt路径及文件
#从txt文件中读取坐标
with open(r"C:\Users\19215\Desktop\location.txt","r",encoding='UTF-8')as f:
...
for i in range(len(location)):
    ...
    for j in range(4):
        ...
        #文件保存名称
        save_name =save_path+str(i+56)+"."+str(j)+".jpg"
        print(url)
        #打开网页
